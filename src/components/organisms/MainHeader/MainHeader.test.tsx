...
describe('Main Header', () => {
    ...
    test('checking the blinkist logo in main header', () => {
        ...
        expect(window.location.pathname).toBe("/myLibrary");
    });
    ...
    test('checking the acconnt dropdown  in main header', () => {
        ...
        const accountMenu = screen.getByTestId("account-dropdown-menu");
        expect(accountMenu).toBeTruthy();
        expect(accountMenu).toBeVisible();
        const accountMenuItems = screen.getAllByRole("menuitem");
        expect(accountMenuItems.length).toBe(5);
    });
